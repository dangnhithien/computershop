...
const Transaction = () => {
  ...
  return (
    <Row gutter={[8, 8]} className="main" align="top">
      ...
      <Col span={24} className="containers">
        ...
        <div className="purchased">
          ...
          <div className="total">&#8363;12.000.000</div>
          <div className="show">
              ...
              <Row gutter={[4, 4]}>
                ...
                <Col span={24}>
                  ...
                  <Text type="italic">
                    ...
                    Est aliquam libero cum quos facere tenetur enim laborum, et
                    reiciendis rerum distinctio perferendis suscipit magni nulla
                    numquam recusandae sunt atque alias.
                  </Text>
                </Col>
                <Col span={24}>
                  <Text strong>Tổng thanh toán:&nbsp;</Text>
                  <Text type="italic">100.000.000</Text>
                </Col>
                <Col span={24}>
                  <Text strong>Đã thanh toán:&nbsp;</Text>
                  <Text type="italic">30.000.000</Text>
                </Col>
                <Col span={24}>
                  <Text strong>Chờ thanh toán:&nbsp;</Text>
                  <Text type="danger">70.000.000</Text>
                </Col>
              </Row>
            </Col>
                    ...
                    <Row gutter={[8, 8]} wrap={false} align="middle">
                      ...
                      <Col>
                        <Row gutter={[0, 0]}>
                          ...
                          <Col span={24}>
                            <Text type="secondary">Giá: 25.000.000 vnđ</Text>
                          </Col>
                          <Col span={24}>
