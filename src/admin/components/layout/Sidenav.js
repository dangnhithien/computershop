...
function Sidenav({ color }) {
  ...
  const account = [
    <img
      width="20"
      height="20"
      src="data:image/png;base64,"
    />,
  ];
  const tables = [
    <svg
        ...
        <Menu.Item key="8">
          <NavLink to="/loai-san-pham">
            <span
              className="icon"
              style={{
                background: page === "loai-san-pham" ? color : "",
              }}
            >
              {add}
            </span>
        ...
        <Menu.Item key="11">
          <NavLink to="/don-hang">
            <span
              className="icon"
              style={{
                background: page === "don-hang" ? color : "",
              }}
            >
              {add}
            </span>
